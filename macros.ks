...
[image layer=1 storage="&f.ARSdigit[2]" width="20" top="500" left="70" visible="true"]
...
[image layer=1 storage="&f.APPdigit[4]" width="20" top="520" left="110" visible="true"]

[image layer=1 storage="UI/number/感度.png" width="75" top="540" left="0" visible="true"]
[image layer=1 storage="&f.SENdigit[1]" width="20" top="540" left="50" visible="true"]
[image layer=1 storage="&f.SENdigit[2]" width="20" top="540" left="70" visible="true"]
[image layer=1 storage="&f.SENdigit[3]" width="20" top="540" left="90" visible="true"]
[image layer=1 storage="&f.SENdigit[4]" width="20" top="540" left="110" visible="true"]

[image layer=1 storage="UI/number/快感.png" width="75" top="560" left="0" visible="true"]
[image layer=1 storage="&f.EROdigit[1]" width="20" top="560" left="50" visible="true"]
